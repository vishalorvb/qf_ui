...
function SearchProject() {
  ...
  function getAutomationType() {
    axios
      .get(baseUrl + "/ProjectsMS/Project/getAutomationType")
      .then((response) => {
        ...
        <Paper elevation={1} sx={{ padding: "10px" }}>
          ...
          >
            ...
            >
              <Grid item xs={6} sm={6} md={5}>
                <label>
                  Repository <span className="importantfield">*</span>:
                </label>
              </Grid>
              <Grid item xs={6} sm={6} md={6}>
                <StyledTextField
                ...
                >
                  {project.map((data) => (
                    <MenuItem value={data.repository_url}>
                      {data.repository_url}
                    </MenuItem>
                  ))}
                </StyledTextField>
