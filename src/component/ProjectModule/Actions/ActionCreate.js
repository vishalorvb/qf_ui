import { Button, Collapse, Container, Grid, IconButton, MenuItem, Paper, Typography } from '@mui/material'
...
function CreateProject(props) {
    ...
    let requiredFields = [description, gitUrl, jenkinsUrl, jenkinsToken, gitAccessToken, branch, jenkinsUsername, jenkinsToken, databaseName, hostName, dbUsername, portNumber, databaseType]
    let specialcharRefs = []
    let passwordRef = []
    if(props.edit){
    }
    ...
    function submitHandler() {
        ...
        console.log()
        if (validateForm(requiredFields, specialcharRefs, passwordRef, onlyAlphabets, onlynumbers, autocompletename, "error")) {
    ...
    return (
        <div onClick={resetClassName}>
            ...
            <SnackbarNotify open={snackbarerror} close={setSnackbarerror} msg="All required fields should be filled" severity="error" />
            <SnackbarNotify open={snackbarsuccess} close={setSnackbarsuccess} msg="Saved Succesfully" severity="success" />
            <Paper elevation={1} sx={{ marginTop: '10px' }} >
                <Box sx={{ marginBottom: '10px', backgroundColor: 'primary.main' }}>
                    ...
                    <Typography variant='p' gutterBottom>Project Information</Typography></Box>
                    ...
                    <Container component={'div'} sx={{ display: "flex", flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around' }} >
                        <Grid container item xs={12} sm={8} md={6} sx={{ marginBottom: '10px' }} >
                            ...
                            <Grid item xs={6} sm={6} md={7}>
                                <input ref={project_name} value={props.project_name} type="text" name="" /></Grid>
                        </Grid>
                        <Grid container item xs={12} sm={8} md={6} sx={{ marginBottom: '10px' }} >
                            ...
                            <Grid item xs={6} sm={6} md={5}>
                                <select ref={automation_type} style={{ width: "100%", height: "28px" }} >
                                    <option value="">Select</option>
                                    {automation.map(data => <option value={data.id}>{data.name}</option>)}
                                </select>
                            </Grid>
                        </Grid>
                ...
                <Collapse in={repository} timeout="auto" unmountOnExit>
                    <Container component={'div'} sx={{ display: "flex", flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around' }} >
                        ...
                        <Grid container item xs={12} sm={8} md={6} sx={{ marginBottom: '10px' }} >
                            ...
                            <Grid item xs={6} sm={6} md={5}> <input ref={branch} type="text" name="" /></Grid>
                        </Grid>
                ...
                <Collapse in={pipeline} timeout="auto" unmountOnExit>
                    <Container component={'div'} sx={{ display: "flex", flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around' }} >
                        <Grid container item xs={12} sm={8} md={6} sx={{ marginBottom: '10px' }} >
                            ...
                            <Grid item xs={6} sm={6} md={7}> <input ref={jenkinsUrl} type="text" name="" /></Grid>
                        </Grid>
                        <Grid container item xs={12} sm={8} md={6} sx={{ marginBottom: '10px' }} >
                            ...
                            <Grid item xs={6} sm={6} md={5}> <input ref={jenkinsToken} type="text" name="" /></Grid>
                        </Grid>
                        <Grid container item xs={12} sm={8} md={6} sx={{ marginBottom: '10px' }} >
                            <Grid item xs={6} sm={6} md={4}><label>Jenkins UserName <span className="importantfield" >*</span>:</label></Grid>
                            <Grid item xs={6} sm={6} md={7}><input ref={jenkinsUsername} type="text" name="" /></Grid>
                        </Grid>
                        <Grid container item xs={12} sm={8} md={6} sx={{ marginBottom: '10px' }} >
                            ...
                            <Grid item xs={6} sm={6} md={5}> <input ref={jenkinsPassword} type="text" name="" /></Grid>
                        </Grid>
                ...
                <Collapse in={database} timeout="auto" unmountOnExit>
                    <Container component={'div'} sx={{ display: "flex", flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around' }} >
                        <Grid container item xs={12} sm={8} md={6} sx={{ marginBottom: '10px' }} >
                            ...
                            <Grid item xs={6} sm={6} md={7}> <input ref={databaseType} type="text" name="" /></Grid>
                        </Grid>
                        <Grid container item xs={12} sm={8} md={6} sx={{ marginBottom: '10px' }} >
            ...
            <Paper elevation={1} sx={{ marginTop: '10px' }}>
                ...
                <Collapse in={collaboration} timeout="auto" unmountOnExit>
                    <Container component={'div'} sx={{ display: "flex", flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around' }} >
                        ...
                        <Grid container item xs={12} sm={12} md={12} sx={{ marginBottom: '10px' }}  >
                            ...
                            <Grid item xs={6} sm={6} md={7.5}> <input ref={projects} type="text" name="" /></Grid>
                            <Grid item xs={6} sm={6} md={2} alignItems="end">
                                <Button size='small' variant="contained" sx={{ marginLeft: "5px" }}  >Verify </Button>
                            </Grid>
                        </Grid>
                ...
                <Grid container item xs={12} sm={12} md={12} sx={{ marginBottom: '20px' }} justifyContent="space-around" >
                    <Button size='small' sx={{ marginBottom: "10px" }} onClick={submitHandler} variant="contained" startIcon={<SaveIcon></SaveIcon>} >Save </Button>
                </Grid>
            </Paper>
