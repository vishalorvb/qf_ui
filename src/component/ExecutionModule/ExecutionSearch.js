...
export default function ExecutionSearch() {
  ...
  return(
    ...
    <Container component={'div'} sx={{display:"flex",flexDirection:'row',flexWrap:'wrap'}} >
      <Grid container item xs={12} sm={6} md={4} sx={{marginBottom:'10px'}} >
        <Grid item xs={6} sm={6} md={5}><label><Typography variant="body2">Automation Type<span className="importantfield" >*</span>:</Typography></label></Grid>
        <Grid item xs={6} sm={6} md={6}> <Autocomplete  options={top100Films}       renderInput={(params) =>  <div ref={params.InputProps.ref}><input {...params.inputProps} /></div>}
/></Grid>
      </Grid>
      <Grid container item xs={12} sm={6} md={4} sx={{marginBottom:'10px'}} >
        <Grid item xs={6} sm={6} md={4}><label><Typography variant="body2">Project<span className="importantfield" >*</span>:</Typography></label></Grid>
        <Grid item xs={6} sm={6} md={6}> <Autocomplete  options={top100Films}       renderInput={(params) => <TextField {...params} label="Movie" />}
/></Grid>
      </Grid>
      <Grid container item xs={12} sm={6} md={4} sx={{marginBottom:'10px'}} >
        <Grid item xs={6} sm={6} md={5}><label><Typography variant="body2">Execution Env. <span className="importantfield" >*</span>:</Typography></label></Grid>
        <Grid item xs={6} sm={6} md={6}> <Autocomplete  options={top100Films}       renderInput={(params) => <TextField {...params} label="Movie" />}
/></Grid>
      </Grid>
      <Grid container item xs={12} sm={6} md={4} sx={{marginBottom:'10px'}} >
        <Grid item xs={6} sm={6} md={5}><label><Typography variant="body2">Testing Env.<span className="importantfield" >*</span>:</Typography></label></Grid>
        <Grid item xs={6} sm={6} md={6}> <Autocomplete  options={top100Films}       renderInput={(params) => <TextField {...params} label="Movie" />}
/></Grid>
      </Grid>
      <Grid container item xs={12} sm={6} md={4} sx={{marginBottom:'10px'}} >
        <Grid item xs={6} sm={6} md={4}><label><Typography variant="body2">Status <span className="importantfield" >*</span>:</Typography></label></Grid>
        <Grid item xs={6} sm={6} md={6}> <Autocomplete  options={top100Films}       renderInput={(params) => <TextField {...params} label="Movie" />}
/></Grid>
      </Grid>
