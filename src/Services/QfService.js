...
export async function getProject(callback, userId) {
    return await axios.get(`${qfservice}/getProjectsOfUser?userId=${userId}`).then(res => {
        callback(res.data.info ?? [])
    })
}

export function getProjectDetails(callback, userId, projectId) {
    axios.get(`${qfservice}/projects/getProjectDetailsByProjectIdAndUserId?user_id=${userId}&project_id=${projectId}`).then(res => {
        callback(res.data.data)
    })
}

export async function makeProjectFav(userId, projectId, value) {
    return await axios.post(`${qfservice}/makeFavourateProject?userId=${userId}&projectId=${projectId}&isFav=${value}`).then(res => {
    })
}
...
export async function deleteProject(projectid, userid) {
    ...
    let res = await axios.put(`${qfservice}/projects/Delete?project_id=${projectid}&user_id=${userid}`).then(r => {
...
export async function getUsers(callback, orgid, ssoid, token) {
    return await axios.get(`${qfservice}/user/listUsers?orgId=${orgid}&ssoId=${ssoid}`,
        {
            headers: {
...
export async function getUserOfProject(callback, projectId, userId) {
    return await axios.get(`${qfservice}/projects/getUsersDetailsByProjectId?project_id=${projectId}`).then(res => {
...
export async function getJiraProject(callback, url, username, password, itstype, orgname, orgid) {
    return axios.post(`${qfservice}/loadJiraProjects?url=${url}&userName=${username}&password=${password}&its_type=${itstype}&org_name=${orgname}&orgId=${orgid}`).then(res => {
        callback(res.data.info)
...
export async function getEnvironment(projectId, moduleId, callback) {
    return await axios.get(`${qfservice}/build-environment?project_id=${projectId}&module_id=${moduleId}`).then(res => {
        callback(res.data ?? [])
        return res.data.data
    })
}
...
export async function getExecutionLocation(projectId, moduleId, callback) {
    return await axios.get(`${qfservice}/execution-environment?module_id=${moduleId}&project_id=${projectId}`).then(res => {
        callback(res.data.data ?? [])
        return res.data.data
    })
}
export async function getTestcaseInTestset(testsetId, callback) {
    return await axios.get(`${qfservice}/webtestset/getTestcasesInWebTestset?testset_id=${testsetId}`).then(res => {
        callback(res.data.info)
        return res.data.info
    })
}
