...
export default function Dashboard() {
    ...
    function getTensorflowData() {
        ...
        axios.post(`/qfdashboard/getTensorflowData?sqe_project_id=${globalProject?.project_id}&userId=${auth?.userId}`).then((res) => {
    ...
    function getPredictionTestcases() {
        axios.post(`/qfdashboard/getPredictionTestcases?sqe_project_id=${globalProject?.project_id}&userId=${auth?.userId}`).then((res) => {
    ...
    function dashboardDetailsBySprintId() {
        ...
        setShowProgressBar(false)
        axios.get(`/qfdashboard/dashboard/${globalProject?.project_id}/${sprintName}?userId=${auth?.userId}`).then((res) => {
            setAutomationTDgraph(false)
            setShowTensorFlow(false)
