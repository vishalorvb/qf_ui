...
export default function Dashboard() {
    ...
    function getTensorflowData() {
        ...
        axios
            .post(
                `${dashboard}/getTensorflowData?sqe_project_id=${globalProject?.project_id}&userId=${auth?.userId}`
            )
            .then((res) => {
    ...
    function getPredictionTestcases() {
        axios
            .post(
                `${dashboard}/getPredictionTestcases?sqe_project_id=${globalProject?.project_id}&userId=${auth?.userId}`
            )
            .then((res) => {
    ...
    function dashboardDetailsBySprintId() {
        ...
        axios
            .get(
                `${dashboard}/dashboard/${globalProject?.project_id}/${sprintName}?userId=${auth?.userId}`
            )
            .then((res) => {
                setAutomationTDgraph(false);
                setShowTensorFlow(false);
    ...
    useEffect(() => {
        ...
        axios
            .post(
                `${dashboard}/getFailTestcasesbyProjectandsprint?project_id=${globalProject?.project_id
