...
import { getReleaseInstances } from "../Services/QfService";
import { deleteInstance } from "../Services/QfService";
...
function Release() {
  ...
  const { setSnackbarData, globalProject, setShowloader, setHeader } =
    useHead();
