...
function ConfirmPop(props) {
   ...
   let {open,handleClose,heading,message,onConfirm} = props;
    ...
    return (
            <Dialog open={open} onClose={handleClose} style={{ marginLeft: "15px", marginTop: "20px" }}>
                <DialogTitle id="alert-dialog-title" className="dialogTitle border-bottom" sx={{
                    ...
                    <Grid container direction="row" justify="space-between" alignItems="center" className="poptitle">
                        <Typography sx={{ marginLeft: 1, marginTop: "auto", marginBottom: "auto " }} variant="inherit">{heading}</Typography>
                ...
                <DialogActions style={{ marginTop: "5px", marginBottom: "5px", marginLeft: "auto", marginRight: "auto" }}>
                    <Button onClick={onConfirm} variant="contained" startIcon={<CheckSharpIcon></CheckSharpIcon>}>
                        Confirm
                    </Button>
                </DialogActions>
            </Dialog>
