    ...
    const onSubmitHandler = (data) => {
        ...
        axios
            .post(
                ...
                }&release_name=${data?.releaseName}&release_desc=${data?.releaseDesc
                }&app_source_code_branch_name=${data?.repoBranch
                }&app_source_code_repo_access_token=${data?.repoToken}&username=${data?.repoUserName
                }&git_url=${data?.repoUrl}&repo_name=${data?.repoName}&credentialsid=${data?.credId
